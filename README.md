...
| Click "Submit" button if the requared fields (name and textarea) are filled in.    | Open tested link https://formdump.codeinstitute.net/                                                                             | Open tested link https://formdump.codeinstitute.net/                                                                             |
| Click "Submit" button if the requared fields (name and textarea) aren't filled in. | Show message "fill in this field".                                                                                               | Show message "fill in this field".                                                                                               |
| Click "Clear" button.                                                              | Clear all text in the input fields.                                                                                              | Clear all text in the input fields.                                                                                              |
...
| Click "hamburger menu". | Open a block with site navigation links. | Open a block with site navigation links. |
...
| Tested on different screen sizes (phones, tablets and laptops). | The site has responsive design. The site adapts to any screen and displays information in a format convenient for work. | The site has responsive design. The site adapts to any screen and displays information in a format convenient for work. |
