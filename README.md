...
| Click the "Get reults" button.                                                      | Display the result based on the number of correct answers.                                                                                | Display the result based on the number of correct answers.                                                                                |
...
| Click the "Submit" button if the requared fields (name and textarea) are filled in. | Open the link https://formdump.codeinstitute.net/ with the filled-in data.                                                                | Open the link https://formdump.codeinstitute.net/ with the filled-in data.net/                                                                                             |
| Click the "Submit" button if the requared fields (name and textarea) aren't filled in.  | Display message "fill in this field".                                                                                                     | Display message "fill in this field".                                                                                                        |
| Click the "Clear" button.                                                               | Clear all text in the inputs fields.                                                                                                       | Clear all text in the inputs fields.                                                                                                       |
